...
"""A library of `keras.metrics.Metrics` and `tf_keras.metrics.Metrics` for learning."""
...
class Keras3NumExamplesCounter(keras.metrics.Sum):
  """A `keras.metrics.Metric` that counts the number of examples seen.
...
class Keras3NumBatchesCounter(keras.metrics.Sum):
  """A `keras.metrics.Metric` that counts the number of batches seen.
