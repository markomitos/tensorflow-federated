...
def create_character_prediction_task_from_datasets_keras3(
    train_client_spec: client_spec.ClientSpec,
    eval_client_spec: Optional[client_spec.ClientSpec],
    sequence_length: int,
    train_data: client_data.ClientData,
  ...
  def model_fn() -> variable.VariableModel:
    return keras_utils.from_keras_model(
        keras_model=char_prediction_models.create_recurrent_keras3_model(
            vocab_size=VOCAB_LENGTH, sequence_length=sequence_length
        ),
...
def create_character_prediction_task_keras3(
    train_client_spec: client_spec.ClientSpec,
    eval_client_spec: Optional[client_spec.ClientSpec] = None,
    sequence_length: int = DEFAULT_SEQUENCE_LENGTH,
    cache_dir: Optional[str] = None,
  ...
  return create_character_prediction_task_from_datasets_keras3(
      train_client_spec,
      eval_client_spec,
      sequence_length,
      train_data,
